...
exps = last_history[last_history['close'] >100000]
...
"""
    SQL                             Pandas
    ORDER BY 칼럼                   df.sort_values(컬럼, ascending=T/F)
    LIMIT 개수                      df.head(개수)
...
print(indexed.loc['G0001',['close', 'changeRate']]) # print(indexed.head(1), ['close', 'changeRate'])