...
"""
    시세(prices) 90,000행에 섹터 이름을 매번 저장하면
            같은 문자열이 수천번 반복될 것임!
...
# how=inner로 머지했을 때, 행이 줄었다면 확인이 어려우므로
#   how=outer, indicator=True 설정하여 어떤 데이터가 빠졌는지 확인할 수 있음!